...
## Instalação
*(Os links diretos para a Chrome Web Store e Edge Add-ons serão adicionados aqui após a publicação.)*
...
Sentindo falta de um site da Microsoft que deveria ser suportado? Por favor, abra uma *issue* ou envie um *pull request*.
...
- `/src`: Código fonte da extensão, incluindo o manifest, interface, lógica em background e utilitários de URL.
